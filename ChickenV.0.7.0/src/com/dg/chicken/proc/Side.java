...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private void tteokbokkiChoice() { // 떡볶이 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products.add(new Product(SideList.sides.get(3).getCode(), SideList.sides.get(3).getName(),
	...
	private void cheeseStickChoice() { // 치즈스틱 선택
		...
		while (runChoice) {
			choice = sc.next();
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products.add(new Product(SideList.sides.get(2).getCode(), SideList.sides.get(2).getName(),
	...
	private void friedShrimpChoice() { // 새우튀김 선택
		...
		while (runChoice) {
			choice = sc.next();
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products.add(new Product(SideList.sides.get(1).getCode(), SideList.sides.get(1).getName(),
	...
	private void frenchFriesChoice() { // 감자튀김 선택
		...
		while (runChoice) {
			choice = sc.next();
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products.add(new Product(SideList.sides.get(0).getCode(), SideList.sides.get(0).getName(),
