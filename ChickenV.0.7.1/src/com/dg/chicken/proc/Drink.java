...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new DrinkList(DrinkList.drinks.get(2).getCode(), DrinkList.drinks.get(2).getName(),
	...
	private void ciderChoice() { // 사이다 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new DrinkList(DrinkList.drinks.get(1).getCode(), DrinkList.drinks.get(1).getName(),
	...
	private void cokeChoice() { // 콜라 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new DrinkList(DrinkList.drinks.get(0).getCode(), DrinkList.drinks.get(0).getName(),
