...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new ChickenList(ChickenList.chickens.get(3).getCode(), ChickenList.chickens.get(3).getName(),
	...
	private void garlicChickenChoice() { // 갈릭치킨 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new ChickenList(ChickenList.chickens.get(2).getCode(), ChickenList.chickens.get(2).getName(),
		...
		while (runChikenTaste) {
			...
			case "1": // 순한맛
				...
				while (runChoice) {
					choice = sc.next();
					if (choice.equals("Y") || choice.equals("y")) {
						ShoppingList.products.add(new ChickenList(ChickenList.chickens.get(1).getCode(),
	...
	private void friedChickenChoice() { // 후라이드치킨 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new ChickenList(ChickenList.chickens.get(0).getCode(), ChickenList.chickens.get(0).getName(),
