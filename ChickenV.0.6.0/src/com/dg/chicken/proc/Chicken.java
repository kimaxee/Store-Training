...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products.add(
						new Product(ChickenList.chickens.get(3).getName(), ChickenList.chickens.get(3).getPrice()));
	...
	private void garlicChickenChoice() { // 갈릭치킨 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products.add(
						new Product(ChickenList.chickens.get(2).getName(), ChickenList.chickens.get(2).getPrice()));
				...
				while (runChoice) {
					...
					if (choice.equals("Y") || choice.equals("y")) {
						ShoppingList.products.add(new Product(
								...
								ChickenList.chickens.get(1).getPrice()));
	...
	private void friedChickenChoice() { // 후라이드치킨 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products.add(
						new Product(ChickenList.chickens.get(0).getName(), ChickenList.chickens.get(0).getPrice()));
