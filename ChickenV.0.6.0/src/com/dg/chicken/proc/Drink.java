...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new Product(DrinkList.drinks.get(2).getName(), DrinkList.drinks.get(2).getPrice()));
	...
	private void ciderChoice() { // 사이다 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new Product(DrinkList.drinks.get(1).getName(), DrinkList.drinks.get(1).getPrice()));
	...
	private void cokeChoice() { // 콜라 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new Product(DrinkList.drinks.get(0).getName(), DrinkList.drinks.get(0).getPrice()));
