...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new Product(SideList.sides.get(3).getName(), SideList.sides.get(3).getPrice()));
	...
	private void cheeseStickChoice() { // 치즈스틱 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new Product(SideList.sides.get(2).getName(), SideList.sides.get(2).getPrice()));
	...
	private void friedShrimpChoice() { // 새우튀김 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new Product(SideList.sides.get(1).getName(), SideList.sides.get(1).getPrice()));
	...
	private void frenchFriesChoice() { // 감자튀김 선택
		...
		while (runChoice) {
			...
			if (choice.equals("Y") || choice.equals("y")) {
				ShoppingList.products
						.add(new Product(SideList.sides.get(0).getName(), SideList.sides.get(0).getPrice()));
